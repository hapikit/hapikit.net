            ...
            while (reader.Read())
            {
                ...
                switch (reader.TokenType)
                {
                    case JsonToken.StartObject:
                        ...
                        DiagSource?.Write("Hapikit.JsonStreamingParser.NewObject", currentContext.Term);
                        break;
                    ...
                    case JsonToken.EndObject:
                        DiagSource?.Write("Hapikit.JsonStreamingParser.EndObject", currentContext.Term);
                        if (ostack.Count > 0)
                        {
                    ...
                    case JsonToken.String:
                        ...
                        {
                            DiagSource?.Write("Hapikit.JsonStreamingParser.MissingTermHandler", new { Context = currentContext, Property = currentProperty });
                        }
                        break;
                }
            }
