...
namespace Hapikit.Links
{
    ...
    {
        protected readonly Dictionary<string, string> _BodyParameters = new Dictionary<string, string>();
        ...
        {
            this.AddRequestBuilder((r) => {
                r.Method = HttpMethod.Post;
                r.Content = new FormUrlEncodedContent(_BodyParameters);
                return r;
            });
        }
