...
namespace Hapikit.Cache
{
    ...
    {
        private readonly Hapikit.Cache.HttpCache _httpCache;


        public HttpCacheHandler(HttpMessageHandler innerHandler, Hapikit.Cache.HttpCache httpCache)
        {
        ...
        protected override async Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
        {
            ...
            {
                Hapikit.Cache.HttpCache.ApplyConditionalHeaders(queryResult,request);
            }
